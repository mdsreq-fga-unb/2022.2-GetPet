...
| [FEAT06] Feedback de viagem | [US14] Como usuário, eu quero ter um histórico de corridas realizadas para revisar detalhes das corridas que realizei e esclarecer qualquer dúvida que eu possa ter. | 1. Usuário precisa ter realizado mais de uma corrida anteriormente. <br> 2. O histórico de corridas deve ser exibido da corrida mais recente para a mais antiga. |
