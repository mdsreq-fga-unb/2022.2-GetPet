...
class _VerChamadosState extends State<VerChamados> {
                                ...
                                FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                                  ...
                                  builder: (_, snapshot) {
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      return data!["longitude"] != 666 ? Text("Distância: ${distancia.as(LengthUnit.Kilometer, LatLng(temp["latitude"], temp["longitude"]), LatLng(data!["latitude"], data["longitude"]))} Km") : const Text("Atualize sua localização na aba Perfil");
                                    }
                              ...
                              children: [
                                ...
                                FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                                    ...
                                    builder: (_, snapshot) {
                                      ...
                                      if (snapshot.hasData) {
                                        var data = snapshot.data!.data();
                                        return data!["longitude"] != 666 ? Text("Valor: ${((distancia.as(LengthUnit.Kilometer, LatLng(temp["latitude"], temp["longitude"]), LatLng(data!["latitude"], data["longitude"]))*3)).toStringAsFixed(2)} R\$") : const Text("Atualize sua localização na aba Perfil");
                                      }
                                      return const Center(child: CircularProgressIndicator());
                                    }
                                ),
  ...
  void _falha(){
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
      ...
      content: Text("Por favor, atualize sua localização na aba Perfil!"),
    ));
  }
}
