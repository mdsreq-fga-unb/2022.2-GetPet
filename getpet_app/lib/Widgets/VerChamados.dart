                            ...
                            FutureBuilder<
                                ...
                                builder: (_, snapshot) {
                                  ...
                                  if (snapshot.hasData) {
                                    ...
                                    return data!["longitude"] != 666
                                        ? Text(
                                            "Valor: ${((distancia.as(LengthUnit.Kilometer, LatLng(temp["latitude"], temp["longitude"]), LatLng(data!["latitude"], data["longitude"])) * 3)).toStringAsFixed(2)} R\$")
                                        : const Text(
                                            "Atualize sua localização na aba Perfil");
                                  }
                                  return const Center(
